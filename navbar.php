...
<head>
  ...
  <link
   ...
   <link rel="stylesheet" href="assets/css/hks-sliders.css?v=2" /> 
     -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link
...
if ($currentFile != 'block.php' && $currentFile != 'contact.php') {
    if (file_exists('block.flag')) {
...
?>
  ...
  <navbar class="nav_main_top">
    <nav class="navbar navbar-expand-lg navbar_padding_custom">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><img src="assets/imgs/logo.svg" class="img-fluid" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
          <a class="nav-link active" href="whats-new.php">What’s New</a>
           </li>
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="our-services.php">Services</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="studio-sets.php">Studio</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="plan-your-day.php">Expert Advice</a>
            </li>
            <li class="nav-item">
  ...
  <script>
    ...
    function handleSearch() {
      ...
      const spaKeywords = [
        'spa', 'spa services', 'relaxation', 'wellness',
        'hands & feet care', 'hands', 'feet care', 'feet',
        'Radiance Whitening', 'Brightening Cleansing', 'Power Bright',
        'Derma Facial', 'Face Bleach', 'Black Head', 'Hydra Facial',
        'Foot Massage', 'Hand Massage', 'Head Massage', 'Shoulder Massage',
        'Body Polisher', 'Gel Nails', 'Nail Extensions', 'Nail Art',
        'Aroma Therapy', 'Holistic Healing', 'whitening facial services',
        'brightening and glow treatments', 'face lifting therapy',
        'hydrating spa treatments', 'manicure and pedicure packages',
        'nail polish and care', 'facial massage services', 'body waxing options',
        'foot and hand spa', 'nail extensions and nail art', 'full body treatments',
        'back and shoulder massages', 'holistic healing therapy',
        'skin care and glow facials', 'acrylic and gel nail services',
        'spa treatments for relaxation', 'massage for muscle tension',
        'therapeutic aroma massages'
      ];

      // Define categories for Makeup Menu
      const makeupKeywords = [
        'makeup', 'makeup menu', 'beauty', 'cosmetics',
        'Signature Barat', 'Signature Nikkah', 'Signature Walima',
        'Signature Engagement', 'Signature Mehndi', 'Barat makeup',
        'Nikkah makeup', 'Walima makeup', 'Engagement makeup',
        'Mehndi makeup', 'Party Makeup Glam', 'Mehndi Application',
        'Final Touch-ups', 'Senior Artist makeup', 'Bridal makeup',
        'wedding makeup', 'DHA Branch makeup', 'Johar Town Branch makeup',
        'makeup tips', 'Pro Makeup Tips', 'makeup for events', 'bridal beauty',
        'professional makeup', 'airbrushed makeup', 'highlighter', 'blush',
        'foundation matching', 'beauty sponge', 'color corrector',
        'makeup blending', 'eyeshadow blending', 'eyeshadow techniques'
      ];
