...
<section class="second_sec_appointments">
    ...
    <div class="book_app_inputs wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">
      ...
      <div class="book_app_inputs wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
    <label for="contact">Contact Number <span class="required_text">(Required)</span></label>
    <input type="tel" name="contact" id="contact" placeholder="0xxxxxxxxxx"
           pattern="0\d{10}" required
           title="Contact number must start with 0 and be 11 digits long">
</div>
    ...
    <div class="book_app_inputs wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
        <label for="email">Email <span class="optional_text">(Optional)</span></label>
